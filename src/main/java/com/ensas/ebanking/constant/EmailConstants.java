...
public class EmailConstants {
    ...
    public static final String USERNAME = "springebanking@gmail.com";
    public static final String PASSWORD = "678DADE3EE.";
    public static final String FROM_EMAIL = "springebanking@gmail.com";
